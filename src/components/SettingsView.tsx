...
export default function SettingsView() {
  ...
  return (
    <div className="p-4 md:p-8 pb-20 max-w-4xl mx-auto space-y-6 md:space-y-12 animate-in fade-in duration-500">
      <header className="border-b border-white/5 pb-8">
        <h1 className="text-2xl md:text-3xl font-bold text-white tracking-tight">System Infrastructure</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-8">
        <section className="space-y-6">
          <div className="bento-card p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] space-y-6">
        ...
        <section className="space-y-6">
          <div className="bento-card p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] border-dashed">
